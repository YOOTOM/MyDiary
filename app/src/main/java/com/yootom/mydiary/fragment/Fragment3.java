...
public class Fragment3 extends Fragment {
    ...
    private void setData2(HashMap<String, Integer> dataHash2) {
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            AppConstants.println(TAG, "#" + i + " -> " + outValue);
            if (outValue != null) {
    ...
    private void setData3(ArrayList<Float> dataKeys3, ArrayList<Integer> dataValues3) {
        AppConstants.println(TAG, "setData3 called.");
        ...
        for (int i = 0; i < dataKeys3.size(); i++) {
            try {
                ...
                AppConstants.println(TAG, "#" + i + " -> " + outKey + ", " + outValue);
    ...
    public void loadStatData() {
        ...
        AppConstants.println(TAG, "recordCount : " + recordCount);
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            AppConstants.println(TAG, "#" + i + " -> " + moodName + ", " + moodCount);
       ...
       /* // 요일별 기분
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            AppConstants.println(TAG, "#" + i + " -> " + weekDay + ", " + moodCount);
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            AppConstants.println(TAG, "#" + i + " -> " + monthDate + ", " + moodCount);
